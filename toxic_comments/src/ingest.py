...
DEFAULT_DATA_URL = "https://huggingface.co/datasets/onejetpilot/toxic_comments/resolve/main/toxic_comments.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download raw toxic comments dataset.")
