...
Простой проект для обучения и запуска модели классификации токсичных комментариев через FastAPI и Docker. Сделан отдельно от исходного ноутбука, чтобы не трогать ваш основной проект.
