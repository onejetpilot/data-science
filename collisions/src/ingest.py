...
DEFAULT_DATA_URL = "https://huggingface.co/datasets/onejetpilot/collisions/resolve/main/df_dtp.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download df_dtp.csv into raw data layer.")
    parser.add_argument("--data-url", type=str, default=DEFAULT_DATA_URL, help="Source URL for df_dtp.csv.")
...
def main() -> None:
    ...
    csv_path = args.output_dir / "df_dtp.csv"

    # 2) Скачиваем CSV или используем существующую копию.
    downloaded = False
    ...
    # 3) Сохраняем manifest для трассировки источника.
    manifest = {
